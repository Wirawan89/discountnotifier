...
-- AlterTable
ALTER TABLE "Showcase" ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
...
CREATE TABLE "UserPreference" (
    ...
    "favoriteCategories" INTEGER[] DEFAULT ARRAY[]::INTEGER[],
    "favoriteSuburbs" TEXT[] DEFAULT ARRAY[]::TEXT[],
