...
type DashboardStats = {
  ...
  activeApiProviders: number;
  todayUserAccess: number;
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Monitor your application's performance and manage configurations
        </p>
      </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-medium text-gray-900">{stats.totalDiscounts}</dd>
                  </dl>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">Today's User Access</dt>
                    <dd className="text-lg font-medium text-gray-900">{stats.todayUserAccess}</dd>
                  </dl>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">Today's Token Usage</dt>
                    <dd className="text-lg font-medium text-gray-900">{stats.todayTokenUsage}</dd>
                  </dl>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="p-5">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">Today's Fetch Operations</dt>
                    <dd className="text-lg font-medium text-gray-900">{stats.todayFetchOperations}</dd>
                  </dl>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <div className="mt-8">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Configure refresh periods and manage categories
                </p>
              </div>
            </Link>
