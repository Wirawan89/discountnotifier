...
function validateBusinessForm(formData: BusinessForm) {
  ...
  if (!formData.promotionMessage.trim()) {
    errors.push({ field: "promotionMessage", message: "Promotion Message is required." });
  }
  ...
  if (!formData.promotionStartDate) {
    errors.push({ field: "promotionStartDate", message: "Promotion From date is required." });
  }
  if (!formData.promotionEndDate) {
    errors.push({ field: "promotionEndDate", message: "Promotion To date is required." });
  }
  if (
